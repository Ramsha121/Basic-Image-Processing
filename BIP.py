...
.app-title {
    ...
    font-size: 3rem;
    font-weight: 900;
    background: linear-gradient(90deg, #800000, #A0522D, #F5DEB3);
...
.animated-title {
    ...
    font-weight: 900;
    text-align: center;
    background: linear-gradient(90deg, #800000, #A0522D, #F5DEB3, #A0522D, #800000);
...
# ====================== CONTOURS ======================
    ...
    cv2.drawContours(contoured, contours, -1, (107,62,46), 2)
